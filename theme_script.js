...
FormRenderer.include({
    ...
    _renderTagNotebook: function (node) {
        ...
        // default first accordion menu item active
        if (renderedTabs.length > 0 && renderedTabs[0].$page.length) {
            renderedTabs[0].$page.find('.panel-heading').removeClass('collapsed');
            renderedTabs[0].$page.find('.panel-heading').attr('aria-expanded', true);
            renderedTabs[0].$page.find('.panel-collapse').addClass('show');
        }
